# -*- coding: utf-8 -*-
"""
Example on how to use HDF5 dataset with TFLearn. HDF5 is a dataset model,
library, and file format for storing and managing data. It can handle large
dataset that could not fit totally in ram memory. 
"""
...
(X, Y), (X_test, Y_test) = cifar10.laod_data()
